...
def get_args_parser():
    ...
    # other settings
    parser.add_argument("--dpr", default=0, type=float, help='drop path rate')
    ...
    parser.add_argument('--use_multi_sup', type=int,default=0)
    parser.add_argument('--use_adaptformer', type=int, default=0)
